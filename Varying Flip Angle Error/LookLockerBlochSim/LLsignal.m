...
%
function [Msig,MLong]=LLsignal(alpha, beta,TI1,TI2,T1,T2,TE,TR,crushFlag, Nll,df,Nex,inc)
...
phi = (1:Nf)/Nf*2*pi*0.9; % Radian phase vector going from 2Pi/Nf to 2Pi in 2Pi/Nf increments.
...
for n=1:Nex %nth TR
    ...
    elseif crushFlag == 2
        phi2 = ((1-Nf/2):Nf/2)/Nf*2*pi*0.90;
        %phi2 = (1:Nf)/Nf*2*pi*0.9;
       for k=1:Nf
